...
pwm =PWM("C20",10 *1000,duty_u16 =32768)
pwm =PWM("C24",10 *1000,duty_u16 =32768)
pwm =PWM("C26",10 *1000,duty_u16 =32768)
...
if BOARD_TYPE == 'RT1021_144P_BTB':
    ...
    LED_PIN = 'C4'
    SWITCH2_PIN = 'D9'
    MOTOR_CHANNEL1_SELECT = MOTOR_CONTROLLER.PWM_C30_DIR_C31
    MOTOR_CHANNEL2_SELECT = MOTOR_CONTROLLER.PWM_C28_DIR_C29
    MOTOR_CHANNEL3_SELECT = MOTOR_CONTROLLER.PWM_D4_DIR_D5
    MOTOR_CHANNEL4_SELECT = MOTOR_CONTROLLER.PWM_D6_DIR_D7
    ...
    LED_PIN = 'C4'
    SWITCH2_PIN = 'C19'
    MOTOR_CHANNEL1_SELECT = MOTOR_CONTROLLER.PWM_C24_DIR_C26
