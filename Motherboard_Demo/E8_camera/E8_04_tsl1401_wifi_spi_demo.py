...
while True:
    if (ticker_flag):
        ...
        wifi.send_ccd_image(WIFI_SPI.CCD1_BUFFER_INDEX, 0x0000)
        wifi.send_ccd_image(WIFI_SPI.CCD2_BUFFER_INDEX, 0xF800)
        if BOARD_TYPE != 'RT1021_100P_2P54':
            wifi.send_ccd_image(WIFI_SPI.CCD3_BUFFER_INDEX, 0x07E0)
            wifi.send_ccd_image(WIFI_SPI.CCD4_BUFFER_INDEX, 0x001F)
