...
//	uint16_t reserved_0;    // 偏移0 保留
//    uint16_t reserved_1;    // 偏移2 保留
//    float    reserved_2;    // 偏移4 保留
...
//	uint16_t reserved_0;    // 偏移0
//    uint16_t reserved_1;    // 偏移2
//    float    reserved_2;    // 偏移4
    uint16_t buffer_energy; // 缓冲能量（单位：J）
    uint16_t shooter_17mm_1_barrel_heat; // 第 1 个 17mm 发射机构的枪口热量
	uint16_t shooter_17mm_2_barrel_heat;  //第 2 个 17mm 发射机构的枪口热量
    uint16_t shooter_42mm_barrel_heat;   // 42mm 发射机构的枪口热量
...
typedef __packed struct  //0x020C     有新增未加
{
    uint16_t mark_hero_progress;
    uint16_t mark_engineer_progress;
    uint16_t mark_standard_3_progress;
    uint16_t mark_standard_4_progress;
//    uint16_t mark_standard_5_progress;
    uint16_t mark_sentry_progress;
